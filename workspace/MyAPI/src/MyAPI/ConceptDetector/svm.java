...
abstract class Kernel extends QMatrix {
	...
	double kernel_function(int i, int j)
	{
		switch(kernel_type)
		{
			...
			case svm_parameter.RBF:
				...
				return Math.exp(-gamma*chisqr(x[i],x[j]));
	...
	static double chisqr(svm_node[] x, svm_node[] y) {
		double sum = 0;
					...
					svm_parameter param)
	{
		switch(param.kernel_type)
		{
			...
			case svm_parameter.RBF:
			{
				...
				*/
				return Math.exp(-param.gamma*chisqr(x, y));
			}
			case svm_parameter.SIGMOID:
