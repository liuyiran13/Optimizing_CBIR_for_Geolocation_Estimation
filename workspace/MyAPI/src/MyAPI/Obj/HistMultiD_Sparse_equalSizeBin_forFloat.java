...
public class HistMultiD_Sparse_equalSizeBin_forFloat <M extends Object> extends HistMultiD_Sparse_generalBin_forFloat<M> {//multi-dimensional hist, as it is Sparse, use hashMap instead of muti-dim array
	/*
	...
	public HistMultiD_Sparse_equalSizeBin_forFloat(boolean saveSample, boolean oneVoteForTwoBin){
		super(saveSample, oneVoteForTwoBin);
	}
	
	public float[] getOneDim_BegEndStp(int dimID){
		return eachDimBegEndStp[dimID];
	}
