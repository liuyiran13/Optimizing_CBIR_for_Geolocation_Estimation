...
public class FastQueue_DIY<T> {
	...
	private FastQueueList_DIY<T> list = new FastQueueList_DIY<T>(this);

	@SuppressWarnings("unchecked")
	public FastQueue_DIY(int initialMaxSize, Class<T> type, boolean declareInstances) {
		this.size = 0;
		this.type = type;
	...
	protected FastQueue_DIY(Class<T> type, boolean declareInstances ) {
	...
	public void addAll( FastQueue_DIY<T> list ) {
