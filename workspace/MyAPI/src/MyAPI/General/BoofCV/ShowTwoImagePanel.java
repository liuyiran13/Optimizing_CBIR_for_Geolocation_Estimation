...
public abstract class ShowTwoImagePanel extends JPanel implements MouseListener , MouseMotionListener{
	...
	public ShowTwoImagePanel(int borderSize , boolean canSelectRegion) {
